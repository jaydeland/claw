...
> Desktop UI for Claude Code with local agent execution, Git worktree isolation, and 16+ MCP server integrations

Claw is an Electron desktop app that wraps the Claude Code SDK, providing a local-first interface for AI-powered development. Run agents in isolated Git worktrees, integrate with MCP servers, and execute code locally without cloud sync.
...
- **16+ Supported Servers** - GitHub, AWS (ECS, Diagram, Documentation, Terraform, API), Datadog, Atlassian, Context7, Chrome DevTools, Figma, Rollbar, Electron, Filesystem, Server-Time
...
3. **GSD** - Project planning
4. **GitHub** - GitHub integration and PR management
5. **Agents** - Agent management
6. **Skills** - Skills library
7. **MCPs** - MCP server list
8. **Terminal** - Terminal sessions
9. **Claws** - Messaging integrations (Slack, WhatsApp)
10. **Prompts** - Saved prompts library
...
- **Settings** - 15+ configuration tabs (appearance, keyboard, MCP, models, beta features, etc.)
