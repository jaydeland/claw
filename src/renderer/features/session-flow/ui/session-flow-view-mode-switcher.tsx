...
type SessionFlowDisplayMode = "side-peek" | "center-peek" | "full-page"

interface SessionFlowViewModeSwitcherProps {
  mode: SessionFlowDisplayMode
  onModeChange: (mode: SessionFlowDisplayMode) => void
}
...
export function SessionFlowViewModeSwitcher({
  mode,
  onModeChange,
}: SessionFlowViewModeSwitcherProps) {
