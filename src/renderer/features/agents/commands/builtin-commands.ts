...
2. Create the file .claw/worktree.json with setup commands
...
Example output for .claw/worktree.json:
{
  "setup-worktree": [
    "bun install",
...
Now analyze this project and create .claw/worktree.json with the appropriate setup commands.`,
}
