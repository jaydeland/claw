...
interface SkillsAndGsdDropdownProps {
  onSkillSelect: (skillName: string) => void
  disabled?: boolean
}

export function SkillsAndGsdDropdown({
  onSkillSelect,
  disabled = false,
}: SkillsAndGsdDropdownProps) {
  ...
  // Separate GSD commands from other skills
      ...
      <DropdownMenuContent align="start" className="w-[240px] max-h-[400px] overflow-y-auto">
        {isLoading ? (
          ...
          <>
            ...
            {gsdCommands.length > 0 && userSkills.length > 0 && <DropdownMenuSeparator />}
