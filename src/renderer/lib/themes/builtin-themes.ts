 ...
 * Warm light theme with soft pastels
 * https://github.com/catppuccin/catppuccin
 */
const CATPPUCCIN_LATTE: VSCodeFullTheme = {
  ...
  colors: {
    ...
    "list.hoverBackground": "#ccd0da99",
    "editor.selectionBackground": "#acb0be44",
    ...
    // Terminal colors - Catppuccin Latte palette
    ...
    "terminal.ansiBrightRed": "#de293a",
    "terminal.ansiBrightGreen": "#49b35a",
    "terminal.ansiBrightYellow": "#eea02e",
    "terminal.ansiBrightBlue": "#3875f4",
    "terminal.ansiBrightMagenta": "#9f5df5",
...
/**
 * Doki Theme - Anime-inspired dark theme with pink/purple accents
 * Vibrant pink primary with dark background and cyan highlights
 */
const DOKI_THEME: VSCodeFullTheme = {
  id: "doki-theme",
  name: "Doki Theme",
  type: "dark",
  source: "builtin",
  colors: {
    ...
    "textLink.activeForeground": "#ff0066",
    "list.activeSelectionBackground": "#313244",
    "list.hoverBackground": "#31324499",
    "editor.selectionBackground": "#ff006633",
    ...
    "button.secondaryForeground": "#f8f8f2",
    // Terminal colors - Doki palette with vibrant accents
...
/**
 * Ruby - Deep red-focused dark theme
 * Rich ruby reds with very dark background and gold/cream accents
 */
const RUBY: VSCodeFullTheme = {
  id: "ruby",
  name: "Ruby",
  type: "dark",
  source: "builtin",
  colors: {
    ...
    "activityBar.background": "#1a0a0a",
    "activityBar.foreground": "#f5f5dc",
    "activityBarBadge.background": "#e0115f",
    "activityBarBadge.foreground": "#ffffff",
    ...
    "editorGroupHeader.tabsBackground": "#1a0a0a",
    "dropdown.background": "#2a1515",
    "dropdown.foreground": "#f5f5dc",
    "input.background": "#2a1515",
    "input.border": "#9b111e",
    "input.foreground": "#f5f5dc",
    "focusBorder": "#e0115f",
    "textLink.foreground": "#ffd700",
    "textLink.activeForeground": "#e0115f",
    "list.activeSelectionBackground": "#2a1515",
    "list.hoverBackground": "#3d2020",
    "editor.selectionBackground": "#e0115f33",
    "editorLineNumber.foreground": "#6b4423",
    "descriptionForeground": "#8b7355",
    "errorForeground": "#ff4444",
    "badge.background": "#e0115f",
    "badge.foreground": "#ffffff",
    "button.background": "#e0115f",
    "button.foreground": "#ffffff",
    "button.secondaryBackground": "#2a1515",
    "button.secondaryForeground": "#f5f5dc",
    // Terminal colors - Ruby palette with deep reds and gold
    "terminal.background": "#0d0d0d",
    "terminal.foreground": "#f5f5dc",
    "terminal.ansiBlack": "#1a0a0a",
    "terminal.ansiRed": "#e0115f",
    "terminal.ansiGreen": "#50c878",
    "terminal.ansiYellow": "#ffd700",
    "terminal.ansiBlue": "#9b111e",
    "terminal.ansiMagenta": "#ff1493",
    "terminal.ansiCyan": "#daa520",
    "terminal.ansiWhite": "#e0d0b0",
    "terminal.ansiBrightBlack": "#4a3535",
    "terminal.ansiBrightRed": "#ff3366",
    "terminal.ansiBrightGreen": "#7ee787",
    "terminal.ansiBrightYellow": "#ffe066",
    "terminal.ansiBrightBlue": "#c41e3a",
    "terminal.ansiBrightMagenta": "#ff69b4",
    "terminal.ansiBrightCyan": "#f0e68c",
    "terminal.ansiBrightWhite": "#ffffff",
  },
}
