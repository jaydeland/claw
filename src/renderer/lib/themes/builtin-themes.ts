...
/**
 * Doki Theme Light - Anime-inspired light theme with pink accents
 * Light variant of Doki Theme with soft pink-tinted background
 */
const DOKI_THEME_LIGHT: VSCodeFullTheme = {
  id: "doki-theme-light",
  name: "Doki Theme Light",
  type: "light",
  source: "builtin",
  colors: {
    ...
    "foreground": "#2d2d2d",
    "sideBar.background": "#ffe0e6",
    "sideBar.foreground": "#2d2d2d",
    "sideBar.border": "#ffc2cc",
    "activityBar.background": "#ffe0e6",
    "activityBar.foreground": "#2d2d2d",
    "activityBarBadge.background": "#ff0066",
    "activityBarBadge.foreground": "#ffffff",
    "panel.background": "#ffe0e6",
    "panel.border": "#ffc2cc",
    "tab.activeBackground": "#fff5f7",
    "tab.inactiveBackground": "#ffe0e6",
    "tab.inactiveForeground": "#8b6b72",
    "editorGroupHeader.tabsBackground": "#ffe0e6",
    "dropdown.background": "#ffc2cc",
    "dropdown.foreground": "#2d2d2d",
    "input.background": "#ffc2cc",
    "input.border": "#ff0066",
    "input.foreground": "#2d2d2d",
    "focusBorder": "#ff0066",
    "textLink.foreground": "#9333ea",
    "textLink.activeForeground": "#ff0066",
    "list.activeSelectionBackground": "#ffc2cc",
    "list.hoverBackground": "#ffc2cc99",
    "editor.selectionBackground": "#ff006633",
    "editorLineNumber.foreground": "#b8a0a6",
    "descriptionForeground": "#8b6b72",
    "errorForeground": "#dc2626",
    "badge.background": "#ff0066",
    "badge.foreground": "#ffffff",
    "button.background": "#ff0066",
    "button.foreground": "#ffffff",
    "button.secondaryBackground": "#ffc2cc",
    "button.secondaryForeground": "#2d2d2d",
    // Terminal colors - Doki Light palette with pastel accents
    "terminal.background": "#fff5f7",
    "terminal.foreground": "#2d2d2d",
    "terminal.ansiBlack": "#ffe0e6",
    "terminal.ansiRed": "#ff3366",
    "terminal.ansiGreen": "#50c878",
    "terminal.ansiYellow": "#daa520",
    "terminal.ansiBlue": "#9333ea",
    "terminal.ansiMagenta": "#ff1493",
    "terminal.ansiCyan": "#22d3ee",
    "terminal.ansiWhite": "#8b6b72",
    "terminal.ansiBrightBlack": "#b8a0a6",
    "terminal.ansiBrightRed": "#ff6699",
    "terminal.ansiBrightGreen": "#7ee787",
    "terminal.ansiBrightYellow": "#ffd700",
    "terminal.ansiBrightBlue": "#c084fc",
    "terminal.ansiBrightMagenta": "#ff69b4",
    "terminal.ansiBrightCyan": "#67e8f9",
...
/**
 * Ruby Light - Light theme with ruby red accents
 * Cream background with elegant ruby red and gold highlights
 */
const RUBY_LIGHT: VSCodeFullTheme = {
  id: "ruby-light",
  name: "Ruby Light",
  type: "light",
  source: "builtin",
  colors: {
    ...
    "editor.foreground": "#6b0f1a",
    "foreground": "#6b0f1a",
    "sideBar.background": "#f5ebe3",
    "sideBar.foreground": "#6b0f1a",
    "sideBar.border": "#e8d5c4",
    "activityBar.background": "#f5ebe3",
    "activityBar.foreground": "#6b0f1a",
    "activityBarBadge.background": "#e0115f",
    "activityBarBadge.foreground": "#ffffff",
    "panel.background": "#f5ebe3",
    "panel.border": "#e8d5c4",
    "tab.activeBackground": "#faf5f0",
    "tab.inactiveBackground": "#f5ebe3",
    "tab.inactiveForeground": "#a08070",
    "editorGroupHeader.tabsBackground": "#f5ebe3",
    "dropdown.background": "#e8d5c4",
    "dropdown.foreground": "#6b0f1a",
    "input.background": "#e8d5c4",
    "input.border": "#e0115f",
    "input.foreground": "#6b0f1a",
    "focusBorder": "#e0115f",
    "textLink.foreground": "#d4af37",
    "textLink.activeForeground": "#e0115f",
    "list.activeSelectionBackground": "#e8d5c4",
    "list.hoverBackground": "#e8d5c499",
    "editor.selectionBackground": "#e0115f22",
    "editorLineNumber.foreground": "#c4a88a",
    "descriptionForeground": "#a08070",
    "errorForeground": "#dc2626",
    "badge.background": "#e0115f",
    "badge.foreground": "#ffffff",
    "button.background": "#e0115f",
    "button.foreground": "#ffffff",
    "button.secondaryBackground": "#e8d5c4",
    "button.secondaryForeground": "#6b0f1a",
    // Terminal colors - Ruby Light palette with ruby red and gold
    "terminal.background": "#faf5f0",
    "terminal.foreground": "#6b0f1a",
    "terminal.ansiBlack": "#f5ebe3",
    "terminal.ansiRed": "#e0115f",
    ...
    "terminal.ansiCyan": "#daa520",
    "terminal.ansiWhite": "#a08070",
    "terminal.ansiBrightBlack": "#c4a88a",
    "terminal.ansiBrightRed": "#ff3366",
    ...
    "terminal.ansiBrightCyan": "#f0e68c",
    "terminal.ansiBrightWhite": "#6b0f1a",
  },
}
...
/**
 * Snazzy Light - Clean light theme based on Hyper Snazzy
 * https://github.com/loilo/vscode-snazzy-light
 */
const SNAZZY_LIGHT: VSCodeFullTheme = {
  id: "snazzy-light",
  name: "Snazzy Light",
  type: "light",
  source: "builtin",
  colors: {
    ...
    "tab.inactiveForeground": "#9194A2",
    "editorGroupHeader.tabsBackground": "#F3F4F5",
    "dropdown.background": "#FAFBFC",
    "dropdown.foreground": "#565869",
    "input.background": "#FAFBFC",
    "input.border": "#E9EAEB",
    "input.foreground": "#565869",
    "focusBorder": "#09A1ED",
    "textLink.foreground": "#09A1ED",
    "textLink.activeForeground": "#F767BB",
    "list.activeSelectionBackground": "#09A1ED22",
    ...
    "button.foreground": "#ffffff",
    "button.secondaryBackground": "#E9EAEB",
    "button.secondaryForeground": "#565869",
    // Terminal colors - Snazzy palette
...
/**
 * SynthWave '84 - Retrowave/neon dark theme by Robb Owen
...
const SYNTHWAVE_84: VSCodeFullTheme = {
  ...
  colors: {
    ...
    "descriptionForeground": "#ffffff73",
    "errorForeground": "#fe4450",
    "badge.background": "#614D85",
    "badge.foreground": "#ffffff",
    "button.background": "#614D85",
    "button.foreground": "#ffffff",
    "button.secondaryBackground": "#2a2139",
    "button.secondaryForeground": "#ffffff99",
    // Terminal colors - SynthWave '84 neon palette
    ...
    "terminal.ansiBrightBlack": "#3b3364",
...
/**
 * Atom One Light - Clean light theme inspired by Atom editor
 * https://github.com/akamud/vscode-theme-onelight
 */
const ATOM_ONE_LIGHT: VSCodeFullTheme = {
  id: "one-light",
  name: "Atom One Light",
  type: "light",
  source: "builtin",
  colors: {
    ...
    "textLink.activeForeground": "#5871EF",
    ...
    "button.foreground": "#FFFFFF",
    "button.secondaryBackground": "#DBDBDC",
    "button.secondaryForeground": "#383A42",
    // Terminal colors - Atom One Light palette
    "terminal.background": "#FAFAFA",
    "terminal.foreground": "#383A42",
    "terminal.ansiBlack": "#2A2C33",
