...
# Sync desktop app to public claw repository
...
PUBLIC_REPO="git@github.com:your-org/claw.git"
PUBLIC_REPO_HTTPS="https://github.com/your-org/claw"
PRIVATE_REPO="21st-dev/21st"
TEMP_DIR="/tmp/claw-sync-$$"
...
if [ -z "$RELEASE_NOTES" ]; then
    ...
    echo "   gh release create $TAG --title \"Claw $TAG\" --notes \"...\""
    echo ""
