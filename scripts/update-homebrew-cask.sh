...
HOMEBREW_TAP_REPO="git@github.com:your-org/homebrew-claw.git"
HOMEBREW_TAP_HTTPS="https://github.com/your-org/homebrew-claw"
...
echo "   brew install your-org/claw/claw"
